...
export default function NudgeCardButton({
  ...
  return (
    <button
      onClick={click}
      disabled={sending}
      className={`inline-flex min-h-11 sm:min-h-8 items-center gap-1 text-xs font-medium px-3 py-1.5 rounded-full border transition-colors disabled:opacity-50 ${
        armed
